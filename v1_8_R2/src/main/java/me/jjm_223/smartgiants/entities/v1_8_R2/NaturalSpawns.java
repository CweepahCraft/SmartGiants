                        ...
                        for (Field list : BiomeBase.class.getDeclaredFields()) {
                            if (list.getType().getSimpleName().equals(List.class.getSimpleName())) {
                                if (field.get(null) == BiomeBase.PLAINS
                                    ...
                                    List metaList = (List) list.get(field.get(null));
                                    if (hostile) {
                                        metaList.add(new BiomeBase.BiomeMeta(SmartGiantHostile.class, frequency,
                                                minGroupAmount, maxGroupAmount));
                                    } else {
                                        metaList.add(new BiomeBase.BiomeMeta(SmartGiant.class, frequency, minGroupAmount,
                                                maxGroupAmount));
                                    }
                                }
                            }
